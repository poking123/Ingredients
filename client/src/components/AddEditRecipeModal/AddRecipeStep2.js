...
import { addOrUpdateRecipeMutation } from '../../queries/queries';
...
function AddRecipeStep2({isMobile, isTablet, stepData, recipeData, ingredientsData, addOrUpdateRecipeMutation, showModalData}) {
...
export default graphql(addOrUpdateRecipeMutation, { name: "addOrUpdateRecipeMutation" })(AddRecipeStep2);